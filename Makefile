...
SOURCES = src/main.c src/config.c src/daemon.c src/poll.c src/queue.c src/plan.c src/operator.c src/syslog.c src/strarray.c src/strhash.c src/pg-util.c
HEADERS = src/workshop.h src/syslog.h src/strarray.h src/strhash.h src/pg-util.h
